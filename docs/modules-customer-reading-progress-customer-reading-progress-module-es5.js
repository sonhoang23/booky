(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-customer-reading-progress-customer-reading-progress-module"], {
    ...
    /***/
    function aFW(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var src_app_core_utils_URL_customer_url_customer_book_customer_url_book__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! src/app/core/utils/URL/customer-url/customer-book/customer-url-book */
      "N7OY");

      var BookService = /*#__PURE__*/function () {
        function BookService(customerUrlBook, http) {
      ...
      BookService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
        providedIn: 'root'
      })], BookService);
      /***/
    },
    ...
    /***/
    function L7e(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CustomerBookReadListDetailComponent", function () {
        return CustomerBookReadListDetailComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_customer_book_read_list_detail_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./customer-book-read-list-detail.component.html */
      "ncb4");
      /* harmony import */


      var _customer_book_read_list_detail_component_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./customer-book-read-list-detail.component.less */
      "wUXq");
      /* harmony import */
      ...
      var src_app_core_services_customer_book_book_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! src/app/core/services/customer/book/book.service */
      "+aFW");
      /* harmony import */
      ...
      var CustomerBookReadListDetailComponent = /*#__PURE__*/function () {
        function CustomerBookReadListDetailComponent(route, destroy$, appErrorHandler, notificationService, bookService, formBuilder, spinner) {
          _classCallCheck(this, CustomerBookReadListDetailComponent);
        ...
        _createClass(CustomerBookReadListDetailComponent, [{
          key: "ngOnInit",
          ...
          value: function getBookInReadListDetail(readListId) {
            ...
            this.bookService.getBookInReadListDetail(readListId).pipe(Object(rxjs_internal_operators_takeUntil__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$)).subscribe(function (result) {
              if (result) {
                console.log(result);

                if (result.isSuccessed) {
                  if (result.resultObj) {
                    _this.bookInReadListDetail = result.resultObj;

                    _this.caculateRemainingDays(result.resultObj.endDate);

                    _this.caculateTotalDays(result.resultObj.startDate, result.resultObj.endDate);

                    _this.readPageCountPercent = Math.floor(result.resultObj.readPageCount / result.resultObj.pageCount * 100);
                    _this.readDays = result.resultObj.readProgresses.length;
                  } else {
          ...
          key: "caculateRemainingDays",
          value: function caculateRemainingDays(endDate) {
            var count = Math.floor((new Date(endDate).getTime() - new Date(Date.now()).getTime()) / (1000 * 60 * 60 * 24));
          ...
          key: "caculateTotalDays",
          value: function caculateTotalDays(startDate, endDate) {
            var count = Math.floor((new Date(endDate).getTime() - new Date(startDate).getTime()) / (1000 * 60 * 60 * 24));
          ...
          key: "initAddReadProgressForm",
          value: function initAddReadProgressForm() {
            try {
          ...
          key: "showAddReadProgressModal",
          value: function showAddReadProgressModal() {
            this.isAddReadProgressModalVisible = !this.isAddReadProgressModalVisible;
            this.initAddReadProgressForm();
          }
        }, {
          key: "handleAddReadProgressModalCancel",
          value: function handleAddReadProgressModalCancel() {
            this.isAddReadProgressModalVisible = false;
          }
        }, {
          key: "handleAddReadProgressModalOk",
          value: function handleAddReadProgressModalOk() {
            var _this2 = this;

            this.handleAddReadProgressModalCancel();
            var val = this.customerAddReadProgressModalForm.value;
            ...
            if (val.readPageToday && val.readPageToday > 0) {
              if (this.readListId) {
                ...
                this.bookService.postReadProgress({
                  readListId: this.readListId,
                  readPageCount: val.readPageToday
                }).subscribe(function (result) {
                  if (result) {
                    //console.log(result);
                    if (result.isSuccessed) {
                      if (result.resultObj) {
                        _this2.getBookInReadListDetail(_this2.readListId);
                  ...
                  _this2.handleAddReadProgressModalCancel();
          ...
          key: "initEditReadProgressForm",
          value: function initEditReadProgressForm() {
            try {
          ...
          key: "showEditReadProgressModal",
          value: function showEditReadProgressModal(readProgressId) {
          ...
          key: "handleEditReadProgressModalCancel",
          value: function handleEditReadProgressModalCancel() {
            this.isEditReadProgressModalVisible = false;
          }
        }, {
          key: "handleEditReadProgressModalOk",
          value: function handleEditReadProgressModalOk() {
            var _this3 = this;

            this.handleEditReadProgressModalCancel();
            var val = this.customerEditReadProgressModalForm.value;
            ...
            if (val.readPageEdit > 0) {
              ...
              this.bookService.putReadProgress({
                readProgressId: this.readProgressIdEdit,
                readPageCount: val.readPageEdit
              }).subscribe(function (result) {
                if (result) {
                  //console.log(result);
                  if (result.isSuccessed) {
                    if (result.resultObj) {
                      _this3.getBookInReadListDetail(_this3.readListId);
                ...
                _this3.handleEditReadProgressModalCancel();
          ...
          key: "initAddCommentProgressForm",
          value: function initAddCommentProgressForm() {
            try {
          ...
          key: "showAddCommentProgressModal",
          value: function showAddCommentProgressModal() {
            this.isAddCommentProgressModalVisible = !this.isAddCommentProgressModalVisible;
            this.initAddCommentProgressForm();
          }
        }, {
          key: "handleAddCommentProgressModalCancel",
          value: function handleAddCommentProgressModalCancel() {
            this.isAddCommentProgressModalVisible = false;
          }
        }, {
          key: "handleAddCommentProgressModalOk",
          value: function handleAddCommentProgressModalOk() {
            var _this4 = this;

            this.handleAddCommentProgressModalCancel();
            var val = this.customerAddCommentProgressModalForm.value;

            if (this.readListId) {
              this.spinner.subjectSubmitLoadingHaveData$.next({
                isSubmitted: true
              });
              this.bookService.postCommentProgress({
                readListId: this.readListId,
                quote: val.quote,
                ...
                if (result) {
                  ...
                  if (result.isSuccessed) {
                    _this4.getCommentProgresses(_this4.readListId);
                ...
                _this4.handleAddReadProgressModalCancel();
          ...
          value: function getCommentProgresses(readListId) {
            ...
            this.bookService.getCommentProgresses(readListId).pipe(Object(rxjs_internal_operators_takeUntil__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$)).subscribe(function (result) {
              if (result) {
                console.log(result);

                if (result.isSuccessed) {
                  if (result.resultObj) {
                    _this5.commentprogresses = result.resultObj;
                  } else {}
                } else {
                  if (result.message) {
                    _this5.notificationService.showErrorNotification(result.message);
                  }
                }
          ...
          key: "initEditCommentProgressForm",
          value: function initEditCommentProgressForm(commentProgressId) {
            try {
          ...
          key: "showEditCommentProgressModal",
          value: function showEditCommentProgressModal(commentProgressIdEdit) {
          ...
          key: "handleEditCommentProgressModalCancel",
          value: function handleEditCommentProgressModalCancel() {
            this.isEditCommentProgressModalVisible = false;
          }
        }, {
          key: "handleEditCommentProgressModalOk",
          value: function handleEditCommentProgressModalOk() {
            var _this6 = this;

            this.handleEditCommentProgressModalCancel();
            var val = this.customerEditCommentProgressModalForm.value;
            this.spinner.subjectSubmitLoadingHaveData$.next({
              isSubmitted: true
            });
            this.bookService.putCommentProgress({
              readListId: this.readListId,
              ...
              if (result) {
                //console.log(result);
                if (result.isSuccessed) {
                  _this6.getCommentProgresses(_this6.readListId);
              ...
              _this6.handleAddReadProgressModalCancel();

              _this6.spinner.subjectSubmitLoadingHaveData$.next({
                isSubmitted: false
              });
            }, function (error) {
          ...
          key: "initEditCommentProgressFromData",
          value: function initEditCommentProgressFromData(commentProgressId) {
            var _this7 = this;

            this.spinner.subjectSubmitLoadingHaveData$.next({
              isSubmitted: true
            });
            var commentProgress = this.commentprogresses.find(function (c) {
              return c.commentProgressId == commentProgressId;
            });
            setTimeout(function () {
              _this7.customerEditCommentProgressModalForm.setValue({
              ...
              _this7.spinner.subjectSubmitLoadingHaveData$.next({
                isSubmitted: false
              });
            }, 5000);
          }
          ...
          key: "changeIsShare",
          value: function changeIsShare(commentProgressId) {
            var _this8 = this;

            this.bookService.postIsShareCommentProgress(commentProgressId).subscribe(function (result) {
              if (result) {
                //console.log(result);
                if (result.isSuccessed) {
                  _this8.getCommentProgresses(_this8.readListId);
              ...
              _this8.handleAddReadProgressModalCancel();

              _this8.spinner.subjectSubmitLoadingHaveData$.next({
                isSubmitted: false
              });
            }, function (error) {
      ...
      CustomerBookReadListDetailComponent.ctorParameters = function () {
        return [{
      ...
      CustomerBookReadListDetailComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["Component"])({
    ...
    function au(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "CustomerReadingProgressModule", function () {
        return CustomerReadingProgressModule;
      });
      /* harmony import */
      ...
      var _customer_reading_progress_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./customer-reading-progress-routing.module */
      "Z61A");
      /* harmony import */


      var _customer_reading_progress_customer_reading_progress_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./customer-reading-progress/customer-reading-progress.component */
      "FNQq");
      /* harmony import */


      var _customer_reading_progress_customer_book_bought_customer_book_bought_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./customer-reading-progress/customer-book-bought/customer-book-bought.component */
      "X9eI");
      /* harmony import */


      var _customer_reading_progress_customer_book_read_list_customer_book_read_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./customer-reading-progress/customer-book-read-list/customer-book-read-list.component */
      "hqqZ");
      /* harmony import */
      ...
      var _customer_reading_progress_customer_book_read_list_detail_customer_book_read_list_detail_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./customer-reading-progress/customer-book-read-list-detail/customer-book-read-list-detail.component */
      "/L7e");

      var CustomerReadingProgressModule = function CustomerReadingProgressModule() {
        _classCallCheck(this, CustomerReadingProgressModule);
      };

      CustomerReadingProgressModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_customer_reading_progress_customer_reading_progress_component__WEBPACK_IMPORTED_MODULE_4__["CustomerReadingProgressComponent"], _customer_reading_progress_customer_book_bought_customer_book_bought_component__WEBPACK_IMPORTED_MODULE_5__["CustomerBookBoughtComponent"], _customer_reading_progress_customer_book_read_list_customer_book_read_list_component__WEBPACK_IMPORTED_MODULE_6__["CustomerBookReadListComponent"], _customer_reading_progress_customer_book_read_list_detail_customer_book_read_list_detail_component__WEBPACK_IMPORTED_MODULE_10__["CustomerBookReadListDetailComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _customer_reading_progress_routing_module__WEBPACK_IMPORTED_MODULE_3__["CustomerReadingProgressRoutingModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], src_app_core_module_core_module__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], src_app_core_module_core_module__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], src_app_core_module_core_module__WEBPACK_IMPORTED_MODULE_7__["MaterialModule"], src_app_core_module_core_module__WEBPACK_IMPORTED_MODULE_7__["NgZorroAntdModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__["TranslateModule"], ngx_infinite_scroll__WEBPACK_IMPORTED_MODULE_9__["InfiniteScrollModule"]]
    ...
    /***/
    function BRI7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function ChuC(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function FNQq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CustomerReadingProgressComponent", function () {
        return CustomerReadingProgressComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_customer_reading_progress_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./customer-reading-progress.component.html */
      "BRI7");
      /* harmony import */


      var _customer_reading_progress_component_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./customer-reading-progress.component.less */
      "OLCj");
      /* harmony import */


      var rxjs_internal_operators_takeUntil__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! rxjs/internal/operators/takeUntil */
      "IW2O");
      /* harmony import */


      var rxjs_internal_operators_takeUntil__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(rxjs_internal_operators_takeUntil__WEBPACK_IMPORTED_MODULE_3__);
      /* harmony import */
      ...
      var src_app_core_services_customer_book_book_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/core/services/customer/book/book.service */
      "+aFW");
      /* harmony import */
      ...
      var CustomerReadingProgressComponent = /*#__PURE__*/function () {
        function CustomerReadingProgressComponent(bookService, // private route: ActivatedRoute,
        notificationService, appErrorHandler, destroy$ // private authService: AuthService, // private suggestService: SuggestService, // private appErrorHandler: AppErrorHandler, // private ratingService: RatingService
          ...
          _classCallCheck(this, CustomerReadingProgressComponent);
        ...
        _createClass(CustomerReadingProgressComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
          ...
          key: "getBookBought",
          value: function getBookBought(pageIndex) {
            var _this9 = this;

            this.bookService.getBookBought({
              pageIndex: pageIndex,
              pageSize: 10
            }).pipe(Object(rxjs_internal_operators_takeUntil__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.destroy$)).subscribe(function (result) {
              if (result) {
                if (result.isSuccessed) {
                  if (result.resultObj) {
                    _this9.pageResult = result.resultObj;
                  } else {
                    _this9.isNotHaveData = true;
                  }
                } else {
                  _this9.isNotHaveData = true;

                  if (result.message) {
                    _this9.notificationService.showErrorNotification(result.message);
                  }
                }
              ...
              _this9.appErrorHandler.handleErrorWithNoti(error);
            });
          }
        }]);
      ...
      CustomerReadingProgressComponent.ctorParameters = function () {
        return [{
      ...
      CustomerReadingProgressComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
    ...
    /***/
    function N7OY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CustomerUrlBook", function () {
        return CustomerUrlBook;
      });
      /* harmony import */
      ...
      var CustomerUrlBook = /*#__PURE__*/function (_customer_url_base__W) {
        _inherits(CustomerUrlBook, _customer_url_base__W);

        var _super = _createSuper(CustomerUrlBook);

        function CustomerUrlBook() {
          _classCallCheck(this, CustomerUrlBook);

          return _super.apply(this, arguments);
        }

        _createClass(CustomerUrlBook, [{
          key: "getBookBought",
          value: function getBookBought(request) {
            var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('pageindex', request.pageIndex == undefined ? '1' : request.pageIndex.toString()).set('pagesize', request.pageSize == undefined ? '10' : request.pageSize.toString());
          ...
          key: "postBookToReadList",
          value: function postBookToReadList() {
            return this.customerUrl + '/book/read-list';
          }
        }, {
          key: "postReadProgress",
          value: function postReadProgress() {
            return this.customerUrl + '/book/read-progress';
          }
        }, {
          key: "putReadProgress",
          value: function putReadProgress() {
            return this.customerUrl + '/book/read-progress';
          }
        }, {
          key: "deleteBookFromReadList",
          ...
          key: "postCommentProgress",
          value: function postCommentProgress() {
            return this.customerUrl + '/book/comment-progress';
          }
        }, {
          key: "putCommentProgress",
          value: function putCommentProgress() {
            return this.customerUrl + '/book/comment-progress';
          }
        }, {
          key: "getCommentProgress",
          value: function getCommentProgress(readListId) {
      ...
      CustomerUrlBook = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
        providedIn: 'root'
      })], CustomerUrlBook);
      /***/
    },
    ...
    /***/
    function OLCj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function X9eI(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CustomerBookBoughtComponent", function () {
        return CustomerBookBoughtComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_customer_book_bought_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./customer-book-bought.component.html */
      "00G5");
      /* harmony import */


      var _customer_book_bought_component_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./customer-book-bought.component.less */
      "ChuC");
      /* harmony import */
      ...
      var src_app_core_services_customer_book_book_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/core/services/customer/book/book.service */
      "+aFW");
      /* harmony import */
      ...
      var CustomerBookBoughtComponent = /*#__PURE__*/function () {
        function CustomerBookBoughtComponent(bookService, // private route: ActivatedRoute,
        notificationService, appErrorHandler, destroy$ // private authService: AuthService, // private suggestService: SuggestService, // private appErrorHandler: AppErrorHandler, // private ratingService: RatingService
        ) {
          _classCallCheck(this, CustomerBookBoughtComponent);
        ...
        _createClass(CustomerBookBoughtComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.getBookBought(1);
          }
          ...
          value: function getBookBought(pageIndex) {
            ...
            this.bookService.getBookBought({
              ...
              if (result) {
                if (result.isSuccessed) {
                  if (result.resultObj) {
                    _this10.pageResult = result.resultObj;
                    console.log(_this10.pageResult);
                  } else {
                    _this10.isNotHaveData = true;
                  }
                } else {
                  _this10.isNotHaveData = true;

                  if (result.message) {
                    _this10.notificationService.showErrorNotification(result.message);
                  }
                }
              ...
              _this10.appErrorHandler.handleErrorWithNoti(error);
            });
          }
        }, {
          key: "addToReadList",
          value: function addToReadList(productId) {
            var _this11 = this;

            console.log(productId);
            this.bookService.postBookToReadList(productId).pipe(Object(rxjs_internal_operators_takeUntil__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$)).subscribe(function (result) {
              if (result) {
                if (result.isSuccessed) {
                  if (result.message) {
                  ...
                  if (result.message) {
                    _this11.notificationService.showErrorNotification(result.message);
                  }
                }
              }
            }, function (error) {
              _this11.appErrorHandler.handleErrorWithNoti(error);
            });
          }
        }]);
      ...
      CustomerBookBoughtComponent.ctorParameters = function () {
        return [{
      ...
      CustomerBookBoughtComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function Z61A(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CustomerReadingProgressRoutingModule", function () {
        return CustomerReadingProgressRoutingModule;
      });
      /* harmony import */
      ...
      var _customer_reading_progress_customer_book_bought_customer_book_bought_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./customer-reading-progress/customer-book-bought/customer-book-bought.component */
      "X9eI");
      /* harmony import */


      var _customer_reading_progress_customer_book_read_list_detail_customer_book_read_list_detail_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./customer-reading-progress/customer-book-read-list-detail/customer-book-read-list-detail.component */
      "/L7e");
      /* harmony import */


      var _customer_reading_progress_customer_book_read_list_customer_book_read_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./customer-reading-progress/customer-book-read-list/customer-book-read-list.component */
      "hqqZ");
      /* harmony import */


      var _customer_reading_progress_customer_reading_progress_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./customer-reading-progress/customer-reading-progress.component */
      "FNQq");
      ...
      var routes = [{
        ...
        children: [{
          ...
          data: {
            title: 'Customer-app.body.user.book.bought' //breadcrumb: 'Cart'
          ...
          data: {
            title: 'Customer-app.body.user.book.read-list' //breadcrumb: 'Cart'
          ...
          data: {
            title: 'Customer-app.body.user.book.read-list-detail' //breadcrumb: 'Cart'

          }
        }]
      }];

      var CustomerReadingProgressRoutingModule = function CustomerReadingProgressRoutingModule() {
        _classCallCheck(this, CustomerReadingProgressRoutingModule);
      };

      CustomerReadingProgressRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function ZEPb(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function hqqZ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CustomerBookReadListComponent", function () {
        return CustomerBookReadListComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_customer_book_read_list_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./customer-book-read-list.component.html */
      "ZEPb");
      /* harmony import */


      var _customer_book_read_list_component_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./customer-book-read-list.component.less */
      "ypvY");
      /* harmony import */
      ...
      var src_app_core_services_customer_book_book_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! src/app/core/services/customer/book/book.service */
      "+aFW");
      /* harmony import */
      ...
      var CustomerBookReadListComponent = /*#__PURE__*/function () {
        function CustomerBookReadListComponent(bookService, notificationService, appErrorHandler, destroy$, // private authService: AuthService, // private suggestService: SuggestService, // private appErrorHandler: AppErrorHandler, // private ratingService: RatingService
        spinner) {
          _classCallCheck(this, CustomerBookReadListComponent);
        ...
        _createClass(CustomerBookReadListComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
          ...
          key: "getBookInReadList",
          value: function getBookInReadList(pageIndex) {
            var _this12 = this;

            this.bookService.getBookInReadList({
              pageIndex: pageIndex,
              pageSize: 10
              ...
              if (result) {
                if (result.isSuccessed) {
                  if (result.resultObj) {
                    _this12.pageResult = result.resultObj;
                    console.log(_this12.pageResult);
                  } else {
                    _this12.isNotHaveData = true;
                  }
                } else {
                  _this12.isNotHaveData = true;

                  if (result.message) {
                    _this12.notificationService.showErrorNotification(result.message);
                  }
                }
              ...
              _this12.appErrorHandler.handleErrorWithNoti(error);
            });
          }
        }, {
          key: "deleteBookFromReadList",
          value: function deleteBookFromReadList(productId) {
            ...
            this.bookService.deleteBookFromReadList(productId).pipe(Object(rxjs_internal_operators_takeUntil__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroy$)).subscribe(function (result) {
              if (result) {
                if (result.isSuccessed) {
                  if (result.message) {
                    _this13.getBookInReadList(1);

                    _this13.notificationService.showSuccessNotification(result.message);
                  }
                } else {
                  if (result.message) {
                    _this13.notificationService.showErrorNotification(result.message);
                  }
                }
              }

              _this13.spinner.subjectSubmitLoadingHaveData$.next({
                isSubmitted: false
              });
            }, function (error) {
              _this13.spinner.subjectSubmitLoadingHaveData$.next({
      ...
      CustomerBookReadListComponent.ctorParameters = function () {
        return [{
      ...
      CustomerBookReadListComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
    ...
    /***/
    function ncb4(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function wUXq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function ypvY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=modules-customer-reading-progress-customer-reading-progress-module-es5.js.map