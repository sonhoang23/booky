          ...
          value: function ngOnInit() {
            ...
            this.orderDetails$.pipe(Object(rxjs_internal_operators_takeUntil__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.destroy$)).subscribe(function (result) {
              if (result.resultObj) {
                ...
                _this.orderAndOrderDetail = result.resultObj;
                console.log(_this.orderAndOrderDetail);
...
//# sourceMappingURL=default~components-admin-body-admin-order-admin-order-module~features-customer-customer-module~selle~e1b3973e-es5.js.map